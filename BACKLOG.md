...
- [ ] **05 — Alerts & Notifications** · [spec](specs/05-alerts-notifications.md) · SMS/email alerts for breakout signals
- [ ] **06 — Options Chain Viewer** · [spec](specs/06-options-chain-viewer.md) · View options chains with Greeks for any ticker
- [ ] **07 — PMCC Analyzer** · [spec](specs/07-pmcc-analyzer.md) · PMCC trade builder with risk/reward visualization
- [ ] **08 — Covered Call Optimizer** · [spec](specs/08-covered-call-optimizer.md) · Optimal strike/expiry selection for covered calls
...
- Broker API integration (Tradier/IBKR) for one-click execution
- Rules-based automation engine
- Backtesting engine for scoring model validation
- Portfolio-level risk management (correlation, sector exposure)
- Paper trading mode
