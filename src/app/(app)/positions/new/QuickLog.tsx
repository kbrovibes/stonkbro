      ...
      <div className="flex flex-col flex-1 px-4 py-5">
        <div className="flex-1 flex flex-col items-center justify-center gap-4">
          ...
          <div className="text-center">
            <p className="text-sm font-bold text-stone-900">Position Logged</p>
  ...
  return (
    <div className="flex flex-col flex-1 px-4 py-5">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-lg font-bold text-stone-900">Log Trade</h2>
      </div>
      ...
      {/* Quick Log Card */}
      <div className="rounded-xl border-2 border-sky-200 bg-white p-5 shadow-sm">
        {/* Symbol + Strategy */}
        <div className="flex items-center gap-2 mb-4">
          <span className="text-base font-bold text-stone-900">{symbol}</span>
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={onEdit}
            disabled={isPending}
            className="text-xs font-semibold text-stone-600 bg-stone-100 hover:bg-stone-200 disabled:opacity-50 px-4 py-2.5 rounded-lg transition-colors whitespace-nowrap"
          >
            Edit Details &rarr;
          </button>
        </div>
