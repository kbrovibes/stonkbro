  ...
  return (
    <div className="flex flex-col pb-8">
      <div className="p-4 pb-2">
        <h1 className="text-xl font-bold text-stone-900 dark:text-text">Jobs</h1>
        <p className="text-xs text-stone-400 dark:text-text-faint">
          Background scans and refreshes across the app
        </p>
      </div>
      ...
      {visible.length === 0 ? (
        <div className="flex flex-col items-center justify-center h-48 gap-2 p-8 text-center">
          <p className="text-sm text-stone-500 dark:text-text-subtle font-medium">
            {jobs.length === 0
              ? "No jobs yet — scans and refreshes you trigger will show up here."
