    ...
    return (
      <div className="flex flex-col flex-1 px-4 py-5 gap-5">
        <div>
          ...
          <p className="text-xs text-stone-500 mt-0.5">Options premium tracker</p>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-4 py-12">
          ...
          <div className="text-center">
            <p className="text-sm font-bold text-stone-900">No income yet</p>
          ...
          <Link
            href="/positions/new"
            className="mt-2 px-5 py-2.5 rounded-xl bg-stone-900 text-white text-sm font-semibold hover:bg-stone-800 transition-colors"
          >
            Add First Position
          </Link>
        </div>
      ...
      <div className="rounded-xl border border-sky-200 bg-sky-50 p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <p className="text-xs font-semibold text-sky-800">Total Premium</p>
            <p className="text-2xl font-extrabold text-emerald-700 mt-0.5">+${fmt(totalPremium)}</p>
          </div>
        </div>
        {totalPremium > 0 && (
      ...
      <div className="rounded-xl border border-stone-200 bg-white p-4">
        ...
        <div className="flex flex-col gap-3">
          {monthlyData.map((m) => (
            <div key={m.month} className="flex items-center gap-3">
              <span className="text-xs font-semibold text-stone-500 w-8">{m.label}</span>
        ...
        <div className="flex items-center gap-4 mt-3 pt-3 border-t border-stone-100">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[10px] text-stone-400">Premium Collected</span>
          </div>
        </div>
      </div>
