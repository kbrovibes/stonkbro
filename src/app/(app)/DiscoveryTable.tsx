    ...
    <div className="grid grid-cols-2 gap-2.5">
      {sorted.map((s) => (
        <Link
          ...
          className="bg-white rounded-xl shadow-sm border border-stone-100 p-3 flex flex-col items-center gap-1 text-center hover:border-stone-300 active:bg-sky-50 transition-colors"
        >
          {/* Score badge */}
          <span
          ...
          {/* Symbol */}
          <span className="text-sm font-bold text-stone-900">{s.symbol}</span>
